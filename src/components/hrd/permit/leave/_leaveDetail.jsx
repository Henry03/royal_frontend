...
const LeaveDetail = ({fetchDataParent, id, ids}) => {
    ...
    const approve = (e, id, ids) => {
        e?.preventDefault()

        toast.promise
        (
            axios.put('/user/leavepermit/approve/'+id, { idStaff: ids},
            {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('admin-token')
                }
            ...
            <div className="modal-box">
                                        ...
                                        {dp.map((value, index) => (  
                                            <div key={index} className="card mt-3 bg-base-100 border">
                                                <div className="card-body">
                                                    ...
                                                    {
                                                        value.approval == 1 && (track == 2 || track == 3 || track == 4 || track == 5) &&
                    ...
                    <div>
                    {
                        ...
                        <div className='grid grid-flow-col gap-5 mt-5'>
                            ...
                            <button className='btn btn-success w-full' onClick={(e)=>approve(e,id,ids)}>Approve</button>
                        </div>
                    }
