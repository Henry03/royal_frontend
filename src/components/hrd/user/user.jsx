...
const User = () => {
    ...
    const fetchData = (e) => {
        ...
        axios.post('/user?page='+currentPage, input, 
        {
            headers: {
        ...
        <>
            <div className="m-5 p-5 md:px-10 bg-base-100 rounded-xl">
                <div className='grid grid-flow-col items-center justify-between'>
                    ...
                    <button className="btn btn-primary w-40" onClick={()=>document.getElementById('addUser').showModal()}>Add User</button>
                </div>
            </div>
                                ...
                                data.map((staff, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className='btn btn-ghost' onClick={()=>{document.getElementById('userDetail').showModal();setId(staff.id)}}><SlOptions/></td>
                                        </tr>
                                    )
                                })
                            }
            ...
            <AddUser fetchDataParent={fetchData}/>
            <UserDetail id={id} fetchDataParent={fetchData}/>
