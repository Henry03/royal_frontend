...
const OutOfDuty = () => {
    ...
    const fetchData = (e) => {
        ...
        axios.post('/outofduty/user?page='+currentPage, input, 
        {
            headers: {
    ...
    return (
        <>
                                ...
                                data.map((permit, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className='btn btn-ghost' onClick={()=>{document.getElementById('outofDutyDetail').showModal();setId(permit.id);setIds(permit.id_staff)}}><SlOptions/></td>
                                        </tr>
                                    )
                                })
                            }
            ...
            <OutofDutyDetail id={id} fetchDataParent={fetchData} ids={ids}/>
