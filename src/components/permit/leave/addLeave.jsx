...
const AddLeave = ({fetchDataParent, value, setValue}) => {
    ...
    const fetchData = (e) => {
        ...
        axios.get('/leavepermit/user/quota',
        {
            headers: {
    ...
    const storeData = (e) => {
        ...
        toast.promise
        (
            axios.post('/leavepermit/user/store', input,
            {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('admin-token')
                }
                    ...
                    <div className='grid grid-flow-row gap-3 items-center'>
                        ...
                        <div className="card card-compact bg-base-100 mt-3 border">
                            <div className="card-body gap-0">
                                ...
                                <textarea className="textarea textarea-bordered" placeholder="Give some note here" value={note} onChange={(e)=>setNote(e.target.value)}></textarea>
                                {
                                    error && error.note &&
                                    <label className="label-text-alt mt-1 text-red-500">{error.note}</label>
                                }
                            </div>
                        </div>
