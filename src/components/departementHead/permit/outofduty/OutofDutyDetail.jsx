...
const OutofDutyDetail = ({fetchDataParent, id}) => {
    ...
    const updateData = (e) => {
        ...
        toast.promise
        (
            axios.put('/user/outofduty/cancel/'+id, {},
            {
                headers: {
    ...
    const reject = () => {
        toast.promise
        (
            axios.put('/user/outofduty/reject/'+id, {},
            {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('admin-token')
                }
                ...
                <div className="modal-box">
                    ...
                    </div>
                    {
                        ...
                        <div className='grid grid-flow-row sm:grid-flow-col gap-3'>
                            <button className='btn btn-error w-full' onClick={()=>reject()}>Reject</button>
                            <button className='btn btn-success w-full' onClick={()=>approve()}>Approve</button>
                        </div>
                    }
                </div>
                <Toaster 
