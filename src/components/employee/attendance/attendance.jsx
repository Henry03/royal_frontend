...
const Attendance = () => {
    ...
    const fetchData = (e) => {
        ...
        axios.post('/attendance?page='+currentPage, input, 
        {
            headers: {
                                                ...
                                                <th>
                                                    {
                                                        new Date(attendance.Tanggal + ' ' + attendance.Shift.Jam_keluar) <= new Date(attendance.time_out.DateTime) ?
                                                            <div className="tooltip tooltip-success text-green-600" data-tip={Math.abs(attendance.time_out.EarlyOut) + " Minutes Late"}>
                                                                {new Date(attendance.time_out.DateTime).toLocaleTimeString('en-SG', formattedTime)}
                                                            </div>
        
                                                        
                                                        :
                                                            <div className="tooltip tooltip-error text-red-500" data-tip={attendance.time_out.EarlyOut + " Minutes Early"}>
                                                                {new Date(attendance.time_out.DateTime).toLocaleTimeString('en-SG', formattedTime)}
                                                            </div>
                                                    }
                                                </th>
